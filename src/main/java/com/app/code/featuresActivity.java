...
public class featuresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       storageReference = FirebaseStorage.getInstance().getReference("sites");
        //storageReference=mstorage.getReferenceFromUrl("gs//finder-4152a.appspot.com");
        databaseReference = FirebaseDatabase.getInstance().getReference().child("features");
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            FirebaseDatabase.getInstance().getReference
                                    ("features").child("com/app/code/sites").push().setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
